...
const delete_arbitrage = async () => {
  guid = uuid.v1();
  var query1 = "Delete from pairpercentages where updatedate < now() - interval '60 seconds'";
  ...
  var query2 = "Delete from pairinfos where updatedate < now() - interval '60 seconds'";
